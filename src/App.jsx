...
function App() {
  ...
  return (
    <>
      <div className='flex items-center z-10 p-[1vw] border-b-[0.2vw] border-black drop-shadow-lg bg-white'>
        <img onClick={logoClick} src={Icon} className='w-[2vw] h-[2vw] cursor-pointer hover:rotate-45 transition-all duration-300 ease-in-out'/>
        <div className='w-[1vw]'/>
      ...
      <div id='container' className={`flex flex-col relative h-[100vh] transition-all duration-300 ease-in-out ${hideBackground ? 'bg-transparent' : 'bg-white'}`}>
        ...
        <div className='flex w-full z-50 relative justify-center items-center'>
          <h2 className='absolute text-[18vw] text-white opacity-15 pointer-events-none'>TRY&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ME!</h2>
